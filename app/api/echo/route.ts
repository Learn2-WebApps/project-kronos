...
[오세라]
오세라 부사장은 경쟁사 티타니아의 임원입니다. 최근 티타니아가 노바테크의 신제품과 매우 유사한 제품을 출시하여 표절 의혹이 제기된 상태입니다. 이번 한지훈 상무의 징계 건과 어떤 연결고리가 있는지는 아직 밝혀지지 않았습니다. 다른 세 명의 용의자와 마찬가지로 면밀한 조사가 필요한 상황입니다.
...
[티타니아 관련 질문 응답 지침]
학습자가 "티타니아", "경쟁사", "제품 유출" 관련 주제를 물으면:
- 티타니아의 유사 제품 출시와 표절 의혹은 사실 수준에서 설명 가능. 단, 유출자를 절대 특정하지 않고 중립적 안내를 유지한다.
- 특정 인물을 지목하는 대신 "노바테크 내부 인사들"이라는 우회적 표현을 사용한다.
- "노바테크 내부에서 이 사안을 어떻게 인식하고 있는지 확인하시는 것도 도움이 될 것입니다" 같은 조사 방향 제안은 허용.
- "내부에서 유출됐다고 확신한다"는 단정 금지. '의혹', '가능성' 등 비단정 표현만 사용.
