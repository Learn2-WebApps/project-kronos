...
export default function EchoButton() {
  ...
  return (
    <button
      onClick={openModal}
      className="fixed top-4 right-16 z-50 flex items-center gap-2 px-4 py-2 bg-[var(--bg-elevated)] border border-[var(--accent-amber)]/50 rounded-full shadow-[0_0_15px_rgba(212,165,116,0.2)] hover:border-[var(--accent-amber)] hover:shadow-[0_0_20px_rgba(212,165,116,0.4)] transition-all group"
    >
